...
- If the user asks for a document, deck, report file, DOCX, PPTX, deep research, broad comparison, strategy, legal/regulatory/medical/health/financial advice, supplement safety, owner/user reliability evidence, failure rates, durability, degradation, evidence-backed workplace/HR policy recommendations, or high-stakes decision support, choose agentic.
