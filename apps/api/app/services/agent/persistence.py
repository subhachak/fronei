...
def had_unresolved_gaps_for_conversation(user_id: str, conversation_id: str | None) -> bool:
    """Return whether the most recently completed turn in this conversation had
    unresolved research gaps, or False if no turns exist yet or the conversation
    doesn't belong to user_id. Mirrors last_turn_route_for_conversation's read
