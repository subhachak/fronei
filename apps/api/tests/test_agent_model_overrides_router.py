"""Coverage for the admin-only enforcement of TurnRequest.model_overrides
at the router boundary (app/routers/agent.py:_sanitize_model_overrides).
...
from app.routers.agent import _sanitize_model_overrides
from app.services.agent.models import TurnRequest


def _request(**overrides) -> TurnRequest:
    return TurnRequest(message="hello", **overrides)
