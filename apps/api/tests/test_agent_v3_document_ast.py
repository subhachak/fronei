...
from app.services.agent_v3.document_ast import document_ast_from_markdown, qa_document_ast, render_docx_from_markdown
...
def test_make_docx_artifact_uses_ast_renderer_and_reports_qa():
    registry = ToolRegistry(tools=AgentV3Tools())
